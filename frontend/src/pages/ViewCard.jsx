      ...
      <div className="screen greeting-screen">
        <div className="greeting-content">
          ...
          <div className="hearts-container">
            <div className="heart" style={{ left: '10%', top: '20%' }}>❤️</div>
            <div className="heart" style={{ left: '30%', top: '50%' }}>💕</div>
            <div className="heart" style={{ left: '70%', top: '30%' }}>💖</div>
            <div className="heart" style={{ left: '90%', top: '60%' }}>💗</div>
          </div>
          <button 
    ...
    return (
      <div className="screen">
        <div className="container">
          ...
          <button className="btn-secondary" onClick={() => setScreen('greeting')}>
            ← Назад
          </button>
        </div>
      </div>
